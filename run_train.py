...
def main():
    ...
    parser.add_argument('--out', type=str, default="results_dir", help='results directory')
    parser.add_argument('--gan_type', type=str, choices=WEIGHTS.keys(), default="StyleGAN2", help='generator model type')
    parser.add_argument('--gan_weights', type=str, default="models/StyleGAN2/checkpoint/060000.pt", help='path to generator weights')
